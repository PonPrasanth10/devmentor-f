...
const perks = [
  { icon: '🔍', text: 'Instant AI code review with bug detection' },
  { icon: '🔒', text: 'Security vulnerability scanning' },
  { icon: '🗺️', text: 'Full project architecture generation' },
  { icon: '⚡', text: 'Powered by Groq — fastest LLM inference' }
];
      ...
      <div className="w-full max-w-4xl grid md:grid-cols-2 gap-8 items-center px-4">
        ...
        <div className="hidden md:block">
          ...
          <h2 className="text-3xl font-bold text-white leading-snug mb-3">
            Ship better code,<br />faster than ever.
          </h2>
          <p className="text-gray-400 text-sm mb-8">
            AI-powered code reviews and project planning for modern developers.
          </p>
